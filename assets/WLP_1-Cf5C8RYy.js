var e=`# Building an LLM-to-Graph Pipeline: Iteration 1 (The Functional Prototype)
...
* **Coreference Resolution:** Tackling the issue of the LLM extracting ambiguous entities (like pronouns or partial names) by passing a small rolling historical context buffer to the extraction layer.`;export{e as default};